    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="bg-white border-b border-gray-200">
                <Link 
                    href="/users" 
                    className="cursor-pointer text-blue-600 p-4 inline-block transition-all duration-300 hover:px-2.5 hover:text-blue-700"
                >
            ...
            {/* User Details Grid */}
            <section className={`${inter.className} md:grid md:grid-cols-6 md:grid-rows-3 flex flex-col justify-center p-4 md:gap-1 gap-2`}>
                {/* User Name and Email */}
                <div className="md:row-start-1 md:col-start-1 md:col-span-1 md:row-span-2 bg-gray-200 rounded-lg px-4 py-2 h-32 flex flex-col justify-center">
                ...
                {/* Address Information */}
                <div className="md:row-start-1 md:col-start-2 md:col-span-2 md:row-span-2 bg-gray-200 rounded-lg px-4 py-2 h-32 flex flex-col justify-center gap-1">
                ...
                {/* Company Information */}
                <div className="md:row-start-1 md:col-start-4 md:col-span-3 md:row-span-2 bg-gray-200 rounded-lg px-4 py-2 h-32 flex flex-col justify-center gap-1">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-900 md:text-lg text-sm flex items-center">
                ...
                {/* Username */}
                <div className="md:col-start-1 md:row-start-3 bg-gray-200 rounded-lg px-4 py-2 h-16 flex flex-col justify-center">
                ...
                {/* Contact Information */}
                <div className="md:col-start-2 md:col-span-3 md:row-start-3 bg-gray-200 rounded-lg px-4 py-2 h-16 flex flex-col justify-center">
